...
//! ```
//!
//! [`Plot`] is the entry point of the library. Start by creating a [`Plot`] and play with it!
//!
//! ## Examples
//!
//! ### Plotting a function
...
//!
//! ![Simple
//! example](https://raw.githubusercontent.com/xavierhamel/termplot/main/assets/example-composed.png)
//!
//! ### Histogram
//! ```rust
//! use termplot::*;
...
//! Output of the previous example:
//!
//! ![Histogram example](https://raw.githubusercontent.com/xavierhamel/termplot/main/assets/example-hist.png)
//!
...
//! Output of the previous example:
//!
//! ![Composed example](https://raw.githubusercontent.com/xavierhamel/termplot/main/assets/example-composed.png)
use std::fmt;
use std::ops;
